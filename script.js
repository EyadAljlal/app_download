const translations = {
    ar: {
        ...
        heroDesc: "تطبيق المفيد هو المنصة المثالية لتجار الجملة لإدارة وإضافة طلباتهم بسرعة وكفاءة عالية.",
        ...
        feat2Desc: "نظام خاص وحصري لتجار الجملة وعملائهم لضمان سلاسة العمليات.",
        feat3Title: "متابعة فورية",
        feat3Desc: "تابع حالة طلباتك في الوقت الفعلي ومن أي مكان عبر تطبيق الهاتف.",
        footer: "&copy; 2026  ToofanSoft جميع الحقوق محفوظة."
    },
    en: {
...
function downloadApk() {
    if (/Android/i.test(navigator.userAgent)) {
        window.location.href = "almofeed-app-releaseV1.0.9.apk";
    } else {
